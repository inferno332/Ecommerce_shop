...
export default function SelectMenu() {
    ...
    return (
        <div className='bg-[#F2F2F2] w-36 sm:w-40 h-fit hover:cursor-pointer z-[2] border-l border-gray-300'>
            <Listbox value={selected} onChange={setSelected}>
                <Listbox.Button className='relative py-3 w-32'>
                    <p>{selected.name}</p>
                ...
                <Transition
                    ...
                    leaveTo='opacity-0'>
                    <Listbox.Options className='fixed mt-1 max-h-60 w-60 overflow-auto rounded-md bg-white py-1 shadow-slate-700 shadow-2xl'>
