...
const Employees = () => {
    ...
    const handleDelete = async (id) => {
        try {
            await axiosJWT.delete(`${process.env.REACT_APP_BASE_URL}/employees/${id}`);
    ...
    const updateData = async (data, params) => {
        try {
            await axiosJWT.patch(`${process.env.REACT_APP_BASE_URL}/employees/${params.row._id}`, data);
            setRefesh((prev) => !prev);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axiosJWT.get(`${process.env.REACT_APP_BASE_URL}/employees`);
